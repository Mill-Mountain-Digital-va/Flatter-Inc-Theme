...
<img class="background-image" alt="hero image of american flag" title="hero image of american flag" src="https://flatterinc.millmountaindigital.com/wp-content/uploads/2022/02/background1.jpeg">
	...
	<div class='hero-slider-text-container'>
	  ...
	  <button alt="contact us" title="contact us" onclick="window.location.href='/contact-us'" class="first-button">Capabilities</button> <button alt="about us" title="about us" onclick="window.location.href='/#accordion-0'" class="second-button">Contact Us</button>
</div>
