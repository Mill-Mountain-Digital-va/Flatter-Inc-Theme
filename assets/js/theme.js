...
const dropdownTextWithButton = Array.from( dropdownTextArray).filter(item => Array.from(item.previousElementSibling).filter(([classList, value]) =>  value === 'dropdown-button');
